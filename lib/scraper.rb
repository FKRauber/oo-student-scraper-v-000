...
class Scraper
  ...
  def self.scrape_profile_page(profile_url)
    ...
    student[:student_bio] = profile_page.css("div.bio-content.content-holder div.description-holder p").text if profile_page.css("div.bio-content.content-holder div.description-holder p")
